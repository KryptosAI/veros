...
const TEST_CASES = [
  ...
  { name: 'Gibberish query → patient overview (no error)', question: 'What color is the sky?', patientId: 'patient-001', userId: 'user-dr-chen', expected: { success: true }, validate: (r) => r.answer.includes('Conditions') || r.answer.includes('Med') },
